...
export default function ContactClient() {
  ...
  const inputClass =
    "w-full px-4 py-3.5 rounded-xl bg-white/5 border border-white/8 text-text-primary placeholder:text-text-muted focus:outline-none focus:border-accent/40 focus:shadow-[0_0_20px_rgba(59,130,246,0.1)] transition-all duration-300";
            ...
            <GlassCard className="p-6 sm:p-8" hover={false} glow>
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-sm font-medium text-text-primary mb-2 font-[family-name:var(--font-heading)]">
                      Name *
                    </label>
                    <input
                      type="text"
