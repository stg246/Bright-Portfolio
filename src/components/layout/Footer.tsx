    ...
    <footer className="relative border-t border-[var(--border-color)] bg-gradient-to-b from-[var(--bg-secondary)] to-[var(--bg-primary)]">
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#d4a843] to-[#b8941f] flex items-center justify-center text-[#1a1a1a] font-bold text-sm shadow-lg shadow-[#d4a843]/25">BA</div>
            ...
            <div className="flex flex-col gap-2 text-sm text-[var(--text-secondary)]">
              <a href={`tel:${siteConfig.phone}`} className="flex items-center gap-2 hover:text-[var(--accent)] transition-colors"><i className="fa-solid fa-phone text-xs w-4" />{siteConfig.phone}</a>
              <a href={`mailto:${siteConfig.email}`} className="flex items-center gap-2 hover:text-[var(--accent)] transition-colors"><i className="fa-solid fa-envelope text-xs w-4" />{siteConfig.email}</a>
              <span className="flex items-center gap-2"><i className="fa-solid fa-location-dot text-xs w-4" />{siteConfig.location}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href={siteConfig.social.github} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl chip flex items-center justify-center text-[var(--text-secondary)] hover:text-[#1a1a1a] hover:bg-gradient-to-br hover:from-[#d4a843] hover:to-[#b8941f] hover:border-transparent hover:shadow-lg hover:shadow-[#d4a843]/25 transition-all duration-300" aria-label="GitHub">
                <i className="fa-brands fa-github" />
              </a>
              <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl chip flex items-center justify-center text-[var(--text-secondary)] hover:text-[#1a1a1a] hover:bg-gradient-to-br hover:from-[#d4a843] hover:to-[#b8941f] hover:border-transparent hover:shadow-lg hover:shadow-[#d4a843]/25 transition-all duration-300" aria-label="LinkedIn">
                <i className="fa-brands fa-linkedin-in" />
              </a>
              <a href={siteConfig.social.twitter} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl chip flex items-center justify-center text-[var(--text-secondary)] hover:text-[#1a1a1a] hover:bg-gradient-to-br hover:from-[#d4a843] hover:to-[#b8941f] hover:border-transparent hover:shadow-lg hover:shadow-[#d4a843]/25 transition-all duration-300" aria-label="Twitter">
        ...
        <div className="mt-12 pt-8 border-t border-[var(--border-color)] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-[var(--text-muted)]">Crafted with <i className="fa-solid fa-heart text-[var(--accent)]" /> and purpose</p>
        </div>
      </div>
    </footer>
  );
